...
DROP POLICY IF EXISTS "Users can view document links" ON public.document_links;
...
DROP POLICY IF EXISTS "Board members can view settings" ON public.board_settings;
...
DROP POLICY IF EXISTS "Board members can view role overrides" ON public.board_role_overrides;
...
DROP POLICY IF EXISTS "Users can create submissions" ON public.document_submissions;
...
DROP POLICY IF EXISTS "Anyone can view role metadata" ON public.roles;
...
DROP POLICY IF EXISTS "Users can view own memberships" ON public.board_memberships;
...
DROP POLICY IF EXISTS "Members can complete their own profile" ON public.board_members;
...
DROP POLICY IF EXISTS "Board members can view COI in their boards" ON public.board_member_coi;
...
DROP POLICY IF EXISTS "Members can manage their own COI" ON public.board_member_coi;
...
DROP POLICY IF EXISTS "Anyone can view compliance categories" ON public.compliance_categories;
...
DROP POLICY IF EXISTS "Users can view compliance items in their org" ON public.compliance_items;
CREATE POLICY "Users can view compliance items in their org"
  ON public.compliance_items FOR SELECT
  USING (org_id IN (SELECT org_id FROM public.profiles WHERE id = auth.uid()));

DROP POLICY IF EXISTS "Users can create compliance items in their org" ON public.compliance_items;
...
DROP POLICY IF EXISTS "Users can update compliance items in their org" ON public.compliance_items;
...
DROP POLICY IF EXISTS "Users can view compliance reviews in their org" ON public.compliance_reviews;
...
DROP POLICY IF EXISTS "Users can create compliance reviews" ON public.compliance_reviews;
CREATE POLICY "Users can create compliance reviews"
  ON public.compliance_reviews FOR INSERT
  WITH CHECK (reviewed_by = auth.uid());

DROP POLICY IF EXISTS "Users can update their own reviews" ON public.compliance_reviews;
CREATE POLICY "Users can update their own reviews"
  ON public.compliance_reviews FOR UPDATE
  USING (reviewed_by = auth.uid());

-- RLS Policies for compliance_templates
DROP POLICY IF EXISTS "Anyone can view compliance templates" ON public.compliance_templates;
...
-- Policies
DROP POLICY IF EXISTS "Users can view their org templates" ON public.staff_form_templates;
...
DROP POLICY IF EXISTS "Users can view reports in their org" ON public.executive_reports;
...
DROP POLICY IF EXISTS "Users can upload reports" ON public.executive_reports;
...
DROP POLICY IF EXISTS "Users can update their own reports" ON public.executive_reports;
...
DROP POLICY IF EXISTS "Users can view minutes in their org" ON public.meeting_minutes;
CREATE POLICY "Users can view minutes in their org"
ON public.meeting_minutes FOR SELECT
USING (org_id IN (SELECT org_id FROM profiles WHERE id = auth.uid()));

DROP POLICY IF EXISTS "Users can upload minutes" ON public.meeting_minutes;
...
DROP POLICY IF EXISTS "Users can update their own minutes" ON public.meeting_minutes;
...
DROP POLICY IF EXISTS "Users can view special papers in their org" ON public.special_papers;
CREATE POLICY "Users can view special papers in their org"
ON public.special_papers FOR SELECT
USING (org_id IN (SELECT org_id FROM profiles WHERE id = auth.uid()));

DROP POLICY IF EXISTS "Users can upload special papers" ON public.special_papers;
CREATE POLICY "Users can upload special papers"
ON public.special_papers FOR INSERT
WITH CHECK (uploaded_by = auth.uid() AND org_id IN (SELECT org_id FROM profiles WHERE id = auth.uid()));

DROP POLICY IF EXISTS "Users can update their own special papers" ON public.special_papers;
...
DROP POLICY IF EXISTS "Users can delete their own minutes" ON storage.objects;
...
DROP POLICY IF EXISTS "Users can delete their own special papers" ON storage.objects;
...
DROP POLICY IF EXISTS "Users can view their org templates" ON public.board_paper_templates;
CREATE POLICY "Users can view their org templates"
ON public.board_paper_templates
FOR SELECT
USING (org_id IN (SELECT org_id FROM public.profiles WHERE id = auth.uid()));

DROP POLICY IF EXISTS "Users can insert templates" ON public.board_paper_templates;
...
DROP POLICY IF EXISTS "Users can update their org templates" ON public.board_paper_templates;
CREATE POLICY "Users can update their org templates"
ON public.board_paper_templates
FOR UPDATE
USING (org_id IN (SELECT org_id FROM public.profiles WHERE id = auth.uid()));

DROP POLICY IF EXISTS "Users can delete their org templates" ON public.board_paper_templates;
...
DROP POLICY IF EXISTS "Users can view approval requests in their org" ON public.approval_requests;
...
DROP POLICY IF EXISTS "Users can view admins in their org" ON public.org_admins;
...
DROP POLICY IF EXISTS "Users can view board papers in their org" ON public.board_papers;
...
DROP POLICY IF EXISTS "Users can create board papers" ON public.board_papers;
...
DROP POLICY IF EXISTS "Users can update their own board papers" ON public.board_papers;
...
DROP POLICY IF EXISTS "Users can delete their own board papers" ON public.board_papers;
...
DROP POLICY IF EXISTS "Users can view boards in their org" ON public.boards;
...
DROP POLICY IF EXISTS "Users can view committee memberships in their org" ON public.committee_memberships;
...
DROP POLICY IF EXISTS "Users can manage committee memberships" ON public.committee_memberships;
...
DROP POLICY IF EXISTS "Board members can insert members in their boards" ON public.board_members;
...
DROP POLICY IF EXISTS "Admins and chairs can update board members" ON public.board_members;
...
DROP POLICY IF EXISTS "Admins and chairs can delete board members" ON public.board_members;
