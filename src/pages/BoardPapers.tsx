            ...
            {boardPapers.length > 0 && (
              <div className="space-y-3">
                ...
                {boardPapers.map((paper) => (
                  <div 
                    key={paper.id} 
                    className="px-4 py-0 border rounded-lg hover:border-primary transition-all cursor-pointer group bg-slate-50"
                  >
                    <div className="grid grid-cols-5 gap-4 items-center">
                      ...
                      <div className="flex justify-end">
                        <Button size="sm" variant="outline" className="text-black border-black hover:bg-primary hover:text-white hover:border-primary transition-colors">
                          Open Document
                        </Button>
                      </div>
                    </div>
