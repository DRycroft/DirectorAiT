-- COMBINED MIGRATIONS WITH FIXES

-- ============================================
-- FILE: 20251018144907_794edf0d-051a-4270-b87d-16a0a3014e47.sql
-- ============================================
...
DROP POLICY IF EXISTS "Users can view their organization" ON public.organizations;CREATE POLICY "Users can view their organization" ON public.organizations
  FOR SELECT USING (
    id IN (SELECT org_id FROM public.profiles WHERE id = auth.uid())
  );

-- Profiles: Users can view all profiles in their org
DROP POLICY IF EXISTS "Users can view profiles in their org" ON public.profiles;CREATE POLICY "Users can view profiles in their org" ON public.profiles
  FOR SELECT USING (
...
DROP POLICY IF EXISTS "Users can view boards they are members of" ON public.boards;CREATE POLICY "Users can view boards they are members of" ON public.boards
  FOR SELECT USING (
...
DROP POLICY IF EXISTS "Users can view board memberships" ON public.board_memberships;CREATE POLICY "Users can view board memberships" ON public.board_memberships
  FOR SELECT USING (
...
DROP POLICY IF EXISTS "Users can view documents in their org" ON public.archived_documents;CREATE POLICY "Users can view documents in their org" ON public.archived_documents
  FOR SELECT USING (
    org_id IN (SELECT org_id FROM public.profiles WHERE id = auth.uid())
    AND (
...
DROP POLICY IF EXISTS "Users can view document snapshots" ON public.document_snapshots;CREATE POLICY "Users can view document snapshots" ON public.document_snapshots
  FOR SELECT USING (
...
DROP POLICY IF EXISTS "Users can view extracted decisions" ON public.extracted_decisions;CREATE POLICY "Users can view extracted decisions" ON public.extracted_decisions
  FOR SELECT USING (
    document_id IN (
...
DROP POLICY IF EXISTS "Users can view their ingest jobs" ON public.ingest_jobs;CREATE POLICY "Users can view their ingest jobs" ON public.ingest_jobs
...
DROP POLICY IF EXISTS "Users can view agendas" ON public.agendas;CREATE POLICY "Users can view agendas" ON public.agendas
  FOR SELECT USING (
    board_id IN (SELECT board_id FROM public.board_memberships WHERE user_id = auth.uid())
  );

-- Agenda items: Follow agenda access
DROP POLICY IF EXISTS "Users can view agenda items" ON public.agenda_items;CREATE POLICY "Users can view agenda items" ON public.agenda_items
  FOR SELECT USING (
    agenda_id IN (
...
DROP POLICY IF EXISTS "Users can view action items" ON public.action_items;CREATE POLICY "Users can view action items" ON public.action_items
  FOR SELECT USING (
    agenda_item_id IN (
...
DROP POLICY IF EXISTS "Admins can view audit log" ON public.audit_log;CREATE POLICY "Admins can view audit log" ON public.audit_log
  FOR SELECT USING (
    EXISTS (
...
DROP TRIGGER IF EXISTS update_boards_updated_at ON public.boards;CREATE TRIGGER update_boards_updated_at BEFORE UPDATE ON public.boards
  FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();

DROP TRIGGER IF EXISTS update_archived_documents_updated_at ON public.archived_documents;
DROP TRIGGER IF EXISTS update_archived_documents_updated_at ON public.archived_documents;CREATE TRIGGER update_archived_documents_updated_at BEFORE UPDATE ON public.archived_documents
  FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();

DROP TRIGGER IF EXISTS update_agendas_updated_at ON public.agendas;
DROP TRIGGER IF EXISTS update_agendas_updated_at ON public.agendas;CREATE TRIGGER update_agendas_updated_at BEFORE UPDATE ON public.agendas
  FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();

DROP TRIGGER IF EXISTS update_agenda_items_updated_at ON public.agenda_items;
DROP TRIGGER IF EXISTS update_agenda_items_updated_at ON public.agenda_items;CREATE TRIGGER update_agenda_items_updated_at BEFORE UPDATE ON public.agenda_items
  FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();

DROP TRIGGER IF EXISTS update_action_items_updated_at ON public.action_items;
DROP TRIGGER IF EXISTS update_action_items_updated_at ON public.action_items;CREATE TRIGGER update_action_items_updated_at BEFORE UPDATE ON public.action_items
  FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();
...
-- ============================================
-- FILE: 20251018145015_22d37d51-a2c3-47f6-a1ab-d09908f24446.sql
-- ============================================

-- Fix security warnings without dropping function

-- Add missing RLS policies for document_snapshots
DROP POLICY IF EXISTS "Users can insert document snapshots" ON public.document_snapshots;CREATE POLICY "Users can insert document snapshots" ON public.document_snapshots
  FOR INSERT WITH CHECK (true);

-- Add missing RLS policies for document_links  
DROP POLICY IF EXISTS "Users can view document links" ON public.document_links;CREATE POLICY "Users can view document links" ON public.document_links
  FOR SELECT USING (
    src_document_id IN (
      SELECT id FROM public.archived_documents WHERE 
        org_id IN (SELECT org_id FROM public.profiles WHERE id = auth.uid())
...
DROP POLICY IF EXISTS "System can create embeddings" ON public.document_embeddings;CREATE POLICY "System can create embeddings" ON public.document_embeddings
  FOR INSERT WITH CHECK (true);

DROP POLICY IF EXISTS "Users can view embeddings" ON public.document_embeddings;
...
DROP POLICY IF EXISTS "System can create audit logs" ON public.audit_log;CREATE POLICY "System can create audit logs" ON public.audit_log
  FOR INSERT WITH CHECK (true);

-- ============================================
-- FILE: 20251018145139_5920d566-c196-4b30-8197-1151b4b2da5e.sql
-- ============================================

-- Create storage bucket for board documents
-- SKIPPED (already exists): INSERT INTO storage.buckets (id, name, public, file_size_limit, allowed_mime_types)
VALUES (
  'board-documents',
  'board-documents',
  false,
...
-- ============================================
-- FILE: 20251018151843_7d082366-466a-48e0-87ae-89de550cff5b.sql
-- ============================================
...
DROP POLICY IF EXISTS "Admins can view all user roles" ON public.user_roles;CREATE POLICY "Admins can view all user roles" ON public.user_roles
  FOR SELECT USING (
...
DROP POLICY IF EXISTS "Board members can view settings" ON public.board_settings;CREATE POLICY "Board members can view settings" ON public.board_settings
  FOR SELECT USING (
    board_id IN (
      SELECT board_id FROM public.board_memberships WHERE user_id = auth.uid()
    )
...
DROP POLICY IF EXISTS "Board members can view role overrides" ON public.board_role_overrides;CREATE POLICY "Board members can view role overrides" ON public.board_role_overrides
  FOR SELECT USING (
    board_id IN (
      SELECT board_id FROM public.board_memberships WHERE user_id = auth.uid()
    )
...
DROP POLICY IF EXISTS "Users can create submissions" ON public.document_submissions;CREATE POLICY "Users can create submissions" ON public.document_submissions
  FOR INSERT WITH CHECK (submitted_by = auth.uid());

DROP POLICY IF EXISTS "Users can view submissions in their org" ON public.document_submissions;
...
DROP TRIGGER IF EXISTS trig_log_submission_review ON public.document_submissions;CREATE TRIGGER trig_log_submission_review
...
DROP TRIGGER IF EXISTS update_board_settings_updated_at ON public.board_settings;CREATE TRIGGER update_board_settings_updated_at
  BEFORE UPDATE ON public.board_settings
  FOR EACH ROW
  EXECUTE FUNCTION public.update_updated_at_column();

-- ============================================
-- FILE: 20251018151912_212d410e-3d82-4c5d-912a-8127493c47c9.sql
-- ============================================
...
DROP POLICY IF EXISTS "Anyone can view role metadata" ON public.roles;CREATE POLICY "Anyone can view role metadata" ON public.roles
  FOR SELECT USING (true);

-- Only super admins can modify role definitions
DROP POLICY IF EXISTS "Super admins can manage roles" ON public.roles;CREATE POLICY "Super admins can manage roles" ON public.roles
  FOR ALL USING (
    public.has_role(auth.uid(), 'super_admin'::app_role)
  );

-- ============================================
-- FILE: 20251020055702_1a8e1528-a823-4bb7-a2a2-7eb9d10cb7b5.sql
-- ============================================
...
-- ============================================
-- FILE: 20251020063739_26674952-5b2a-4b5e-9a0b-84045b5d227e.sql
-- ============================================
...
-- Triggers for updated_at
DROP TRIGGER IF EXISTS update_templates_updated_at ON templates;CREATE TRIGGER update_templates_updated_at
  BEFORE UPDATE ON templates
  FOR EACH ROW
  EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS update_document_drafts_updated_at ON document_drafts;CREATE TRIGGER update_document_drafts_updated_at
  BEFORE UPDATE ON document_drafts
  FOR EACH ROW
  EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS update_user_template_preferences_updated_at ON user_template_preferences;CREATE TRIGGER update_user_template_preferences_updated_at
...
-- ============================================
-- FILE: 20251020082929_54cbaa26-170b-4196-a011-76129541a14b.sql
-- ============================================
...
-- ============================================
-- FILE: 20251020100431_6386fa02-7842-4736-93a3-dea2cbbfa338.sql
-- ============================================
...
-- ============================================
-- FILE: 20251020102249_b2a43003-0468-4336-86bd-a01198e129a1.sql
-- ============================================
...
-- ============================================
-- FILE: 20251020103403_1d0626bf-d3ca-43f4-b195-482c589ba1e7.sql
-- ============================================
...
-- ============================================
-- FILE: 20251020103543_c6af7d02-1a3f-4ad0-9f13-d37c0f4d59fd.sql
-- ============================================
...
-- ============================================
-- FILE: 20251020103700_27117cf7-9475-43d7-a465-638a4a05525d.sql
-- ============================================
...
-- ============================================
-- FILE: 20251020103853_e1213829-7862-4dcf-bff1-31f5e3bd2700.sql
-- ============================================
...
-- ============================================
-- FILE: 20251020103959_514cbb45-53c7-4eb5-a346-8583a18510a4.sql
-- ============================================
...
-- ============================================
-- FILE: 20251020111120_2888261d-f973-496c-bb9d-fcccf7fa88af.sql
-- ============================================
...
DROP TRIGGER IF EXISTS update_board_members_updated_at ON public.board_members;CREATE TRIGGER update_board_members_updated_at
  BEFORE UPDATE ON public.board_members
  FOR EACH ROW
  EXECUTE FUNCTION public.update_updated_at_column();

DROP TRIGGER IF EXISTS update_board_member_coi_updated_at ON public.board_member_coi;CREATE TRIGGER update_board_member_coi_updated_at
...
-- ============================================
-- FILE: 20251020112328_950c4ede-357b-44a6-92e5-25358aba4806.sql
-- ============================================
...
-- ============================================
-- FILE: 20251020112350_98031be2-5803-4ced-8da1-c5b4ff8027e1.sql
-- ============================================
...
-- ============================================
-- FILE: 20251020113347_a2f2f50f-09cc-486f-b243-2018639e05df.sql
-- ============================================
...
-- ============================================
-- FILE: 20251020134129_4a3d9927-f0c8-492d-9a76-d9caaa292ccc.sql
-- ============================================
...
DROP TRIGGER IF EXISTS update_compliance_items_updated_at ON public.compliance_items;CREATE TRIGGER update_compliance_items_updated_at
...
-- ============================================
-- FILE: 20251020134832_85772c2c-fed4-47a7-ab9c-8ca688469089.sql
-- ============================================
...
-- Create trigger
DROP TRIGGER IF EXISTS organization_compliance_scan_trigger ON public.organizations;CREATE TRIGGER organization_compliance_scan_trigger
BEFORE UPDATE ON public.organizations
FOR EACH ROW
EXECUTE FUNCTION public.trigger_compliance_scan();

-- ============================================
-- FILE: 20251020143049_c4b90435-c22f-4deb-879e-eda15aa950d6.sql
-- ============================================
...
-- ============================================
-- FILE: 20251021003538_e2ce76f7-4d93-41a0-adad-a7278bc4fbdd.sql
-- ============================================
...
-- ============================================
-- FILE: 20251021015450_9335d49f-6157-4829-a0e4-ab351b810bd7.sql
-- ============================================
...
-- Create trigger for updated_at
DROP TRIGGER IF EXISTS update_staff_form_templates_updated_at ON public.staff_form_templates;CREATE TRIGGER update_staff_form_templates_updated_at
...
-- ============================================
-- FILE: 20251021020819_f67c1c37-426d-4b2c-b6b4-a39256b22621.sql
-- ============================================
...
-- ============================================
-- FILE: 20251021054234_ad895bf3-d1d5-421c-a595-b83cf3746b93.sql
-- ============================================
...
-- ============================================
-- FILE: 20251021070202_ea72fd67-933f-4587-913b-08f6b156b5d2.sql
-- ============================================

-- Create storage bucket for executive reports
-- SKIPPED (already exists): INSERT INTO storage.buckets (id, name, public)
...
-- ============================================
-- FILE: 20251021070616_c6a66b90-9865-49d9-b54d-b7df04584584.sql
-- ============================================
...
-- ============================================
-- FILE: 20251021072106_39454fb5-feaa-4e93-bef8-e9529d930816.sql
-- ============================================
...
DROP TRIGGER IF EXISTS update_board_paper_templates_updated_at ON public.board_paper_templates;CREATE TRIGGER update_board_paper_templates_updated_at
...
DROP TRIGGER IF EXISTS assign_default_role_trigger ON public.profiles;CREATE TRIGGER assign_default_role_trigger
AFTER INSERT ON public.profiles
FOR EACH ROW
EXECUTE FUNCTION public.assign_default_role();

-- ============================================
-- FILE: 20251021074407_99730a1c-1399-49d0-bcb7-39b29f3af602.sql
-- ============================================
...
-- Create trigger for updated_at
DROP TRIGGER IF EXISTS update_approval_requests_updated_at ON public.approval_requests;CREATE TRIGGER update_approval_requests_updated_at
...
-- ============================================
-- FILE: 20251021080033_d415fcb1-3ed3-4878-8348-154a6c807352.sql
-- ============================================
...
-- ============================================
-- FILE: 20251021080834_4d2473d9-43c3-4c22-8bed-b6d14422017d.sql
-- ============================================
...
-- ============================================
-- FILE: 20251026063942_3b952029-8e71-4668-a445-7f7b8a3889ec.sql
-- ============================================
...
DROP POLICY IF EXISTS "Restrict org creation to users without org" ON organizations;CREATE POLICY "Restrict org creation to users without org" ON organizations
FOR INSERT 
TO authenticated
WITH CHECK (
  auth.uid() IN (
...
-- ============================================
-- FILE: 20251026064957_5f6da396-26fc-43a8-9a5f-aba3293ea2a1.sql
-- ============================================
...
-- ============================================
-- FILE: 20251026065410_6ef9f906-a256-4ab2-a9a6-83cbbd9c54ef.sql
-- ============================================
...
-- ============================================
-- FILE: 20251026070633_aa0165d0-c7c4-407b-a418-88909dbf47df.sql
-- ============================================
...
-- ============================================
-- FILE: 20251026070747_0741d017-0b5e-45b4-85de-4eede01b7ed2.sql
-- ============================================
...
-- ============================================
-- FILE: 20251030041215_4b5808fd-ddf3-4e79-8668-db1cee9eaf90.sql
-- ============================================
...
-- Triggers for updated_at
DROP TRIGGER IF EXISTS update_dashboard_templates_updated_at ON dashboard_templates;CREATE TRIGGER update_dashboard_templates_updated_at
  BEFORE UPDATE ON dashboard_templates
  FOR EACH ROW
  EXECUTE FUNCTION public.update_updated_at_column();

DROP TRIGGER IF EXISTS update_dashboard_widgets_updated_at ON dashboard_widgets;CREATE TRIGGER update_dashboard_widgets_updated_at
  BEFORE UPDATE ON dashboard_widgets
  FOR EACH ROW
  EXECUTE FUNCTION public.update_updated_at_column();

DROP TRIGGER IF EXISTS update_dashboard_metrics_updated_at ON dashboard_metrics;CREATE TRIGGER update_dashboard_metrics_updated_at
  BEFORE UPDATE ON dashboard_metrics
  FOR EACH ROW
  EXECUTE FUNCTION public.update_updated_at_column();

-- ============================================
-- FILE: 20251030051317_21532d08-0054-40a2-b651-3fe0eaa1741d.sql
-- ============================================
...
-- ============================================
-- FILE: 20251030061012_29eab321-1717-4ff3-83f4-1bc0eae0d783.sql
-- ============================================
...
-- ============================================
-- FILE: 20251030061213_9bc50d28-758a-4cce-aba4-d3433ec93d03.sql
-- ============================================
...
-- ============================================
-- FILE: 20251030061418_c0e43cd1-9f02-4ca4-93f8-8964699e049f.sql
-- ============================================
...
-- ============================================
-- FILE: 20251030061917_0a67c16f-55f8-4b5a-be4a-d0a74dac5585.sql
-- ============================================
...
-- ============================================
-- FILE: 20251030092932_cbdf2527-92e5-4e68-9a62-10a727990126.sql
-- ============================================
...
DROP TRIGGER IF EXISTS update_board_papers_updated_at ON public.board_papers;CREATE TRIGGER update_board_papers_updated_at
...
-- ============================================
-- FILE: 20251030094241_982d8fb8-2f50-4992-b21b-30ec7e848528.sql
-- ============================================
...
-- ============================================
-- FILE: 20251030095705_fcfd9b30-f151-42ae-b264-1fd7239bb7e3.sql
-- ============================================
...
-- ============================================
-- FILE: 20251030095926_7716342a-74db-4a01-9532-c6ccbfbce42c.sql
-- ============================================
...
-- ============================================
-- FILE: 20251030100022_f7b551f7-3cb7-42b3-8721-2726eb2185f0.sql
-- ============================================
...
-- ============================================
-- FILE: 20251030100800_a8f373b2-faac-4deb-ada8-d58d9eb3b109.sql
-- ============================================
...
-- ============================================
-- FILE: 20251030101141_a227042d-d8f0-44bf-8a7a-07562ecb40c1.sql
-- ============================================
...
-- ============================================
-- FILE: 20251030101422_60b81864-92e2-4179-a685-0a0cf2ba1820.sql
-- ============================================
...
-- ============================================
-- FILE: 20251030101450_b0ce2893-6105-40dd-9fe6-f176854339ad.sql
-- ============================================
...
-- ============================================
-- FILE: 20251030101804_2234acb1-9532-49ad-88d4-6663f793a4eb.sql
-- ============================================
...
-- ============================================
-- FILE: 20251030102641_024d2441-2a0c-4cd6-8b45-b0ee49e44d6a.sql
-- ============================================
...
DROP TRIGGER IF EXISTS update_committee_memberships_updated_at ON public.committee_memberships;CREATE TRIGGER update_committee_memberships_updated_at
BEFORE UPDATE ON public.committee_memberships
FOR EACH ROW
EXECUTE FUNCTION public.update_updated_at_column();

-- ============================================
-- FILE: 20251030115337_16dd1617-3654-41bd-824d-aab2a0dbf5d0.sql
-- ============================================
...
-- ============================================
-- FILE: 20251101014650_9595fe90-5c69-40b3-ae5f-3ca5aae8f332.sql
-- ============================================
